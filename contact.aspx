...
<head runat="server">
    ...
    <meta charset="utf-8">
    <title>Thevedaverse -contact</title>
...
<body>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="position-relative w-100 carousel-image1" src="img/contact-us.jpg">
                    ...
                    <div class="contact-form bg-secondary rounded p-5">
                        ...
                        <div>
                            <div class="control-group">
                                <asp:TextBox ID="TextBox1" class="form-control border-1 m-2 p-4" placeholder="Your Name" runat="server"></asp:TextBox>
                            </div>
                            <div class="control-group">
                                <asp:TextBox ID="TextBox2" class="form-control border-1 m-2 p-4" placeholder="Your Email" runat="server"></asp:TextBox>
                                                           
                            <div class="control-group">
                               <asp:TextBox ID="TextBox3" class="form-control border-1 m-2 p-4" placeholder="Your Subject" runat="server"></asp:TextBox>
                                 
                            </div>
                            <div class="control-group">
                                <asp:TextBox ID="TextBox4" class="form-control border-1 m-2 p-4" placeholder=" Your Message" runat="server" TextMode="MultiLine" Height="150"></asp:TextBox>
                                
                            </div>
                            <div class="text-center">
                                <asp:Button ID="Button1" class="carousel-button btn-primary "  runat="server" Text="Send" OnClick="Button1_Click" />
    ...
    <div class="text-center">
        <a href="mailto:thevedaverse77@gmail.com" target="_blank" class="m-2 text-decoration-none text-dark"><img
                src="img/gmail.png"> Email us: thevedaverse77@gmail.com </a><br><br>
        <a href="https://wa.me/7412879735" target="_blank" class=" m-2 text-decoration-none text-dark"><img
                src="img/WATSAPp_1.png">Talk
            on: 7412879735 </a><br><br>
        <a href="https://instagram.com/thevedaverse?igshid=NTc4MTIwNjQ2YQ==" target="_blank"
            class=" m-2 text-decoration-none text-dark"><img src="img/instagram.png"> DM us
            : Instagram </a>
    </div>
    <!-- social media Handles start end -->
  <!-- Footer Start -->
