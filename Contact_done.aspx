<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Contact_done.aspx.cs" Inherits="Contact_done" %>
...
<head runat="server">
    ...
    <meta charset="utf-8">
    <title>TheVedaVerse-Message send</title>
                ...
                <div class="p-5" style="width: 100%; max-width: 900px;">
                    ...
                    <br/><br/><br/>
                        ...
                        <h2 class="display-5 text-white mb-md-4 m-2"><em class="text-primary text-center m-0">We will Connect you soon
                            </em><br/>Message Succesfully Send 
