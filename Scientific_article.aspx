<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Scientific_article.aspx.cs" Inherits="Scientific_article" %>
...
<body>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="position-relative w-100 carousel-image1" src="img/carousel__2.png">
            <div class="carousel-caption d-flex align-items-center justify-content-center">
                <div class="p-5" style="width: 100%; max-width: 900px;">

                    <br/><br/><br/>
                     <form id="form1" runat="server">
                        <h2 class="display-5 text-white mb-md-4 m-2"><em class="text-primary text-center m-0">Coming
                                Soon
                            </em><br>If You are interested then plz submit your email

                        </h2>
                        <asp:TextBox ID="TextBox1" class="form-control border-light inputsm" style="padding: 5px;"
                            placeholder="Your Email Address" runat="server"></asp:TextBox>
                       
                        <asp:Button ID="Button1" class="carousel-button   btn-primary  m-3" runat="server" Text="Submit" OnClick="Button1_Click" />
